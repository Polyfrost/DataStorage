...
## Third-party OneConfig mod categories

You can add your own mod to [this JSON file](https://github.com/Polyfrost/DataStorage/blob/main/oneconfig/third-party-mod-categories.json) to place it in a OneConfig category without supporting it directly. Simply make a PR and we'll approve it. The ID format is mod name, spaces replaced with dashes, all lowercase.
